...
Blockly.Blocks['operator_letters_of'] = {
  /**
   * Block for "letter _ through _ of _" operator.
   * @this Blockly.Block
   */
  init: function() {
    this.jsonInit({
...
Blockly.Blocks['operator_remove_letter_of'] = {
  /**
   * Block for "remove letter _ of _" operator.
   * @this Blockly.Block
   */
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.OPERATORS_REMOVELETTEROF,
      "args0": [
        {
          "type": "input_value",
          "name": "LETTER"
...
Blockly.Blocks['operator_remove_letters_of'] = {
  /**
   * Block for "letter _ through _ of _" operator.
   * @this Blockly.Block
   */
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.OPERATORS_REMOVELETTERSOF,
      "args0": [
        {
          "type": "input_value",
          "name": "LETTER1"
